...
def main():
    ...
    parser.add_argument('--rp-launch-id',
                        help='ReportPortal launch ID')
    ...
    parser_list_tests = subparsers.add_parser('list_tests',
                        help='Print tests in given launch')

    # create the parser for the "change_defects" command
    parser_change_defects = subparsers.add_parser('change_defects',
                        help='Change defects in given launch')
    parser_change_defects.add_argument('--from-defect',
                        help='Take these defects (e.g. to_investigate/ti001')
    parser_change_defects.add_argument('--to-defect',
                        help='And change them to these defects (e.g. no_issue/ni001)')
    parser_change_defects.add_argument('--to-defect-comment',
                        help='Comment to add to the test with changed defect')
